...
_This chapter covers project setup and the Lake build system. If you already have your environment configured, skip to [Data Structures](./06_data_structures.md). Return here when you need multi-file projects or dependencies._
...
| `elan override`       | Set directory-specific toolchain        | `elan override set leanprover/lean4:v4.33.1` |
