...
If you want the theoretical foundations: [Type Theory](./14_type_theory.md) covers the core calculus. [Dependent Types](./15_dependent_types.md) explains why types can mention values. [Tactics](./appendix_c_tactics.md) and [Proof Strategy](./16_proof_strategy.md) cover how to actually get proofs done. [Artificial Intelligence](./23_artificial_intelligence.md) discusses where this is heading.
