...
| ------------- | -------------------------------------- | --------------------------------------------------------- |
| **`def`**     | Define a value or function             | [Basics](./05_basics.md#zero)                             |
| **`theorem`** | State and prove a proposition (opaque) | [Basics](./05_basics.md#zero), [Proving](./11_proving.md) |
| **`lemma`**   | Same as `theorem`                      | [Proving](./11_proving.md)                                |
| **`example`** | Anonymous proof (not saved)            | [Type Theory](./12_type_theory.md)                        |
| **`abbrev`**  | Transparent abbreviation               | [Basics](./05_basics.md#more-declarations)                |
...
| Declaration      | Purpose                  | Example                                                    |
| ---------------- | ------------------------ | ---------------------------------------------------------- |
| **`import`**     | Load another module      | [Basics](./05_basics.md#modules-and-namespaces)            |
| **`variable`**   | Auto-add to definitions  | [Basics](./05_basics.md#modules-and-namespaces)            |
| **`namespace`**  | Group under prefix       | [Basics](./05_basics.md#modules-and-namespaces)            |
| **`section`**    | Scope for variables      | [Basics](./05_basics.md#modules-and-namespaces)            |
| **`open`**       | Bring names into scope   | [Basics](./05_basics.md#modules-and-namespaces)            |
...
| **`export`**     | Re-export from namespace | [Basics](./05_basics.md#modules-and-namespaces)            |
...
| ------------- | ---------------------- | ------------------------------------------ |
| **`#eval`**   | Evaluate and print     | [Basics](./05_basics.md#zero)              |
| **`#check`**  | Display type           | [Basics](./05_basics.md#more-declarations) |
| **`#print`**  | Print declaration info | [Basics](./05_basics.md#more-declarations) |
| **`#reduce`** | Reduce to normal form  | [Basics](./05_basics.md#more-declarations) |
